...
class VirtualMachineDocsExtension(PluginTemplateExtension):
    ...
    def right_page(self):
        ...
        return self.render('nbtools/nbtools/vm_docs_box.html', extra_context={'docs': docs})
...
class ApplicationDocsExtension(PluginTemplateExtension):
    ...
    def right_page(self):
        ...
        return self.render('nbtools/nbtools/app_docs_box.html', extra_context={'docs': docs})
